...
The committed WAST manifest is pinned to `WebAssembly/spec` commit `fc209c5ed8afc4dfeb9252024d217da3376c7a6f`. At this consolidation point it covers 23 unique upstream sources and 640 selected assertions with zero filters.
