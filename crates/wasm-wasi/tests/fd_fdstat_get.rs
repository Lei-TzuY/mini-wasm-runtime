...
use wasm_wasi::{
    ...
    RIGHTS_FD_READDIR, RIGHTS_FD_SEEK, RIGHTS_FD_TELL, RIGHTS_FD_WRITE, RIGHTS_PATH_CREATE_FILE,
    RIGHTS_PATH_LINK_SOURCE, RIGHTS_PATH_LINK_TARGET, RIGHTS_PATH_OPEN, RIGHTS_PATH_RENAME_SOURCE,
    RIGHTS_PATH_RENAME_TARGET, RIGHTS_PATH_UNLINK_FILE,
};
