...
fn pinned_upstream_f64_add_sub_mul_signed_zero_and_subnormal_vectors_match_spec() {
    ...
    for (opcode, lhs_bits, rhs_bits, expected_bits) in [
        ...
        (0xa0, 0x0000_0000_0000_0001, 0x0000_0000_0000_0001, 0x0000_0000_0000_0002), // min subnormal + itself
        (0xa1, 0x8000_0000_0000_0000, 0x0000_0000_0000_0000, 0x8000_0000_0000_0000), // -0 - +0 = -0
        (0xa1, 0x0000_0000_0000_0000, 0x0000_0000_0000_0001, 0x8000_0000_0000_0001), // +0 - min subnormal
        (0xa2, 0x8000_0000_0000_0000, 0x3ff0_0000_0000_0000, 0x8000_0000_0000_0000), // -0 * +1 = -0
        (0xa2, 0x8000_0000_0000_0000, 0x8000_0000_0000_0000, 0x0000_0000_0000_0000), // -0 * -0 = +0
    ] {
        assert_eq!(
