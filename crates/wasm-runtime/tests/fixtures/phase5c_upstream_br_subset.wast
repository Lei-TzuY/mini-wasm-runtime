...
;; Scope: already-supported unconditional branch composition, including nop/drop/select/br_table.
...
(assert_return (invoke "as-select-second" (i32.const 0) (i32.const 1)) (i32.const 6))
