...
fn recursive_call_indirect_module() -> Vec<u8> {
    ...
    let factorial = [
        0x20, 0x00, 0x45, 0x04, I32, 0x41, 0x01, 0x05, 0x20, 0x00, 0x20, 0x00, 0x41, 0x01, 0x6b,
        0x41, 0x00, 0x11, 0x00, 0x00, 0x6c, 0x0b,
    ];
    let fibonacci = [
        0x20, 0x00, 0x41, 0x01, 0x4d, 0x04, I32, 0x41, 0x01, 0x05, 0x20, 0x00, 0x41, 0x02, 0x6b,
        0x41, 0x01, 0x11, 0x00, 0x00, 0x20, 0x00, 0x41, 0x01, 0x6b, 0x41, 0x01, 0x11, 0x00, 0x00,
        0x6a, 0x0b,
    ];
