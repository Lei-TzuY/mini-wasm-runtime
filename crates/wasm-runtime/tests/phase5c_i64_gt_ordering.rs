...
#[test]
fn i64_gt_s_matches_pinned_upstream_ordering_vectors() {
    for &(lhs, rhs, expected) in GT_S_CASES {
        assert_eq!(run(I64_GT_S, lhs, rhs), expected, "gt_s({lhs}, {rhs})");
    }
}
