...
#[test]
fn validator_rejects_promote_demote_type_confusion() {
    let cases = [
        (0xb6, F32, F32, ValueType::F64, ValueType::F32),
        (0xbb, F64, F64, ValueType::F32, ValueType::F64),
    ];
...
#[test]
fn validator_rejects_reachable_promote_demote_underflow() {
    for (opcode, param, result) in [(0xb6, F64, F32), (0xbb, F32, F64)] {
        assert!(matches!(
...
#[test]
fn promote_demote_obey_unreachable_stack_polymorphism() {
