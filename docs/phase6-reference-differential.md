...
Wasmtime and WAT remain confined to the nested workspace and dedicated Ubuntu CI job; no product dependency, workspace member, or Rust 1.81 MSRV change is introduced. Automatic capture/shrinking of real mismatches, imported-function/table combinations, broader multi-value/stateful corpora, and additional trap taxonomy remain follow-up work.
