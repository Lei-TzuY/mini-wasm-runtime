...
- [x] pinned upstream-spec translated-vector tranche for supported numeric semantics
- [ ] systematic upstream `.wast` ingestion with explicit supported-feature filtering
